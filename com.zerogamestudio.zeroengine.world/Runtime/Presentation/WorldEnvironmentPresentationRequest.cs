...
{
    public sealed class WorldEnvironmentPresentationRequest
    {
        public WorldEnvironmentPresentationRequest(
            string profileId,
        ...
        private static string NormalizeRequiredId(string value, string parameterName)
        {
            ...
            if (string.IsNullOrEmpty(normalized))
            {
                throw new ArgumentException(
                    "A non-empty environment presentation identifier is required.",
                    parameterName);
            }
